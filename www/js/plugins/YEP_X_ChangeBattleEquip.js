 ...
 *
 * @param Equip Cost
 * @desc Limit Gauge Cost for Changing Equipment
 * @default 25
 *
 * @help
 * ============================================================================
...
Yanfly.Param.CBECost = Number(Yanfly.Parameters['Equip Cost']);
...
Game_Actor.prototype.canBattleEquipChange = function() {
    ...
    if ($gameParty.partyLimitGauge() < Yanfly.Param.CBECost) {
      this._cacheCanCBattleEquipChange = false;
      return this._cacheCanCBattleEquipChange;
    }
