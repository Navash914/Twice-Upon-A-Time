...
Scene_Battle.prototype.createTurnOrderDisplay = function() {
  ...
  this._originalBattlers = this._turnOrderDisplay;
...
Scene_Battle.prototype.updateTurnOrderDisplayX = function() {
  ...
  var newLength = $gameTroop.members().length;
  if (newLength > this._trueLength) this.refreshNewTurnOrderDisplay();
  var length = this._turnOrderDisplay.length;
  for (var i = 0; i < length; ++i) {
...
Scene_Battle.prototype.refreshNewTurnOrderDisplay = function() {
//  if (!this._turnOrderDisplay) this.createTurnOrderDisplay();
  var length = this._originalBattlers.length;
  for (var i = 0; i < length; ++i) {
      this._originalBattlers[i].clearWindow();
  }
...
Scene_Battle.prototype.refreshTurnOrderDisplay = function() {
  if (!this._turnOrderDisplay) this.createTurnOrderDisplay();
//  var newLength = $gameTroop.members().length;
//  if (newLength !== this._trueLength) this.createTurnOrderDisplay();
  var length = this._turnOrderDisplay.length;
  for (var i = 0; i < length; ++i) {
...
Window_TurnOrderIcon.prototype.clearWindow = function() {
  this.contents.clear();
};
