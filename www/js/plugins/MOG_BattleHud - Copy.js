...
// ** create Battle Hud
//==============================
Scene_Battle.prototype.create_battle_hud = function() {
...
//==============================
Scene_Battle.prototype.create_screen_layout = function() {	
...
// * Update Hud visible
//==============================
Scene_Battle.prototype.update_hud_visible = function() {
...
// * Is Hud Visible
//==============================
Scene_Battle.prototype.is_hud_visible = function() {
...
// ** Update
//==============================
var _alias_mog_bhud_scbat_update = Scene_Battle.prototype.update
...
// ** Refresh Battle Hud
//==============================
Scene_Battle.prototype.refresh_battle_hud = function() {
...
// * Refresh Number
//==============================
Battle_Hud.prototype.refresh_number = function(sprites,value,img_data,x) {
...
Battle_Hud.prototype.create_hp_number = function() {
	...
	this.refresh_number(this._hp_number,this._hp_number_old,this._hp_img_data,this._hp_img_data[4]);	
};
...
Battle_Hud.prototype.create_maxhp_number = function() {
	...
	this.refresh_number(this._maxhp_number,this._maxhp_number_old,this._maxhp_img_data,this._maxhp_img_data[4]);	
};
...
Battle_Hud.prototype.create_mp_number = function() {
	...
	this.refresh_number(this._mp_number,this._mp_number_old,this._mp_img_data,this._mp_img_data[4]);	
};
...
Battle_Hud.prototype.create_maxmp_number = function() {
	...
	this.refresh_number(this._maxmp_number,this._maxmp_number_old,this._maxmp_img_data,this._maxmp_img_data[4]);	
};
...
Battle_Hud.prototype.create_tp_number = function() {
	...
	this.refresh_number(this._tp_number,this._tp_number_old,this._tp_img_data,this._tp_img_data[4]);	
};
...
Battle_Hud.prototype.create_maxtp_number = function() {
	...
	this.refresh_number(this._maxtp_number,this._maxtp_number_old,this._maxtp_img_data,this._maxtp_img_data[4]);	
};
