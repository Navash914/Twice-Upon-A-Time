...
Window_StatCompare.prototype.refresh = function() {
 ...
 //   this.drawScrollImage();
    this.drawGeneralText();
	if(this._actor && this._tempActor && this._showCompare) {
...
Window_StatCompare.prototype.drawGeneralText = function() {
    var x = 0;
    var maxWidth = this.contents.width;
    var color = this.textColor(17);
    this.changeTextColor(color);
    this.drawText('Stat Comparison', x, 0, maxWidth, 'center');
};
...
Window_StatCompare.prototype.drawScrollImage = function() {
