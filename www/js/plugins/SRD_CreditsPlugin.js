 ...
 *
 * @param Window Width
 * @desc Percentage of Screen for Credits List
 * @default 0.5
 *
 * @param Help Window Height
 * @desc Height of Help Window
 * @default 2
 *
 * @param Help Window Text
 * @desc Text in Help Window
 * @default Hello World
 *
 * @param Help Window Text Size
 * @desc Size Text in Help Window
 * @default 28
 *
...
_.listWidth = Number(params['Window Width']);
_.helpHeight = Number(params['Help Window Height']);
_.helpText = String(params['Help Window Text']);
_.helpTextSize = Number(params['Help Window Text Size']);
...
Scene_SRD_Credits.prototype.createHelpWindow = function() {
	this._helpWindow = new Window_CreditsHelp();
...
Scene_SRD_Credits.prototype.createCategoryWindow = function() {
	...
	this._categoryWindow = new Window_CreditsCategory(x, y);
...
Scene_SRD_Credits.prototype.createCreditsWindow = function() {
    ...
    var windowWidth = _.listWidth;
	var width = (_.descWindow) ? Graphics.boxWidth * windowWidth : Graphics.boxWidth;
...
Scene_SRD_Credits.prototype.createDescriptionWindow = function() {
    var descWidth = 1 - _.listWidth;
	this._descriptionWindow = new Window_CreditsDescripton(Graphics.boxWidth * descWidth, this._creditWindow.height);
...
Window_CreditsHelp.prototype = Object.create(Window_Base.prototype);
Window_CreditsHelp.prototype.constructor = Window_CreditsHelp;

Window_CreditsHelp.prototype.initialize = function() {
    var width = Graphics.boxWidth;
    var height = this.fittingHeight(_.helpHeight);
    Window_Base.prototype.initialize.call(this, 0, 0, width, height);
    this.fillHelp();
//    this._text = '';
};    
    
Window_CreditsHelp.prototype.fillHelp = function() {
    var text = _.helpText;
    this.contents.fontSize = _.helpTextSize;
...
Window_CreditsCategory.prototype.initialize = function(x, y) {
...
//		this._descriptionWindow.setDescription(''); // Error Here
//	}
};
