 ...
 * @default false
 *
 * @param Show Dark Rectangles
 * @desc Show Dark Rectangles in the party menu?
 * NO - false     YES - true
 * @default true
 *
...
Yanfly.Param.PartyDarkRectangles = String(Yanfly.Parameters['Show Dark Rectangles']);
Yanfly.Param.PartyDarkRectangles = eval(Yanfly.Param.PartyDarkRectangles);
...
Window_PartyDetail.prototype.clear = function() {
    this.contents.clear();
    if (Yanfly.Param.PartyDarkRectangles) this.drawDarkRect(0, 0, this.contents.width, this.contents.height);
...
Window_PartyDetail.prototype.refresh = function() {
    ...
    if (Yanfly.Param.PartyDarkRectangles) this.drawDarkRectangles();
