...
Window_StatCompare.prototype.setShow = function(eval) {
//    if (this._showCompare === eval) return;
    this._showCompare = eval;
    this.createWidths();
    this.refresh();
};
...
Scene_Equip.prototype.commandCancel = function() {
...
Scene_Equip.prototype.onSlotOk = function() {
    ...
    this._compareWindow.setShow(true);
};
...
Scene_Equip.prototype.onSlotCancel = function() {
    ...
    this._compareWindow.setShow(null);
};
